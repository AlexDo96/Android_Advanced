 ...
 */
public class AdapterLoai6 extends RecyclerView.Adapter<AdapterLoai6.MyViewHolder> {
    ...
    public AdapterLoai6(Context context, ArrayList<Information> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        ...
        View view = inflater.inflate(R.layout.layout_one_item_loai6, parent, false);
