...
public class ScrollHandler {
	...
	// ScrollHandler setaora 5 đoituongcho game
	private Grass frontGrass, backGrass; // cotren, coduoi
	private Pipe pipe1, pipe2, pipe3; // 3 duongong

	// hang so dequyetdinhkhoangcachdecuonngoaira no con
	// quyetdinhkhoangcachgiua 2 duongong
	...
	public void update(float delta) {
		...
		// kiemtra 1 duongongdaroikhoi man hinhthi cap nhap no vesau
